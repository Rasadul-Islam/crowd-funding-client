...
const AddCampains = () => {
    ...
    const handleAddcampaign = event => {
        ...
        fetch('https://crowd-server-one.vercel.app/campaign', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className='container mx-auto flex flex-col  items-center my-5'>
            <form onSubmit={handleAddcampaign} className="card-body w-3/4 max-w-xl lg:max-w-5xl rounded-lg shadow-xl border-2 border-purple-200 shadow-purple-300 grid grid-cols-1 lg:grid-cols-2 gap-5">
                <h1 className='text-3xl md:col-span-2 font-bold text-center text-purple-400 mt-1'>Add New Campaign</h1>
                ...
                <div className="flex flex-col md:col-span-2 mt-1 w-full max-w-xl mx-auto items-center">
                    <input type="submit" value="Add" className='btn hover:text-purple-300 border-2 border-purple-400 px-3 py-2 rounded-lg bg-purple-100 font-bold text-center text-xl mb-5 mt-10 w-full max-w-52' />
                </div>
